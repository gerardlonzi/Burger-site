        ...
        <div className='lg:px-20  flex justify-center items-center md:block' >
            ...
            <div className='flex mt-36 flex-col '>
                ...
                <div classname='relative '>
                    <img data-aos="flip-right" data-aos-delay="500"  data-aos-easing="ease-in-out" src={burger_heros} alt="Burger-hero" className='lg:absolute top-14 xl:top-2  lg:w-2/4 w-full md:w-3/4 right-8 2xl:right-16' />
