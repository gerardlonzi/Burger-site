...
export default function Footer() {
  ...
  return (
    <div className=' mt-44 mb-10  px-16 w-full'>
        <div className='bg-yellow-600 h-footer relative '>
            ...
            <div className='absolute top-0 w-full px-14 pt-28 flex flex-col gap-16  text-white'>
                <div>
                    <img src={logo} alt="logo house burger"className='w-1/3' />
                </div>
                <div className='flex justify-between' >
                    <div className='text-lg font-normal'>
                        Lorem, 
                        Laudantium perspiciatis molestias ea voluptatum aut<br /> voluptatum aut quia accusamus laboriosam voluptatum aut<br />architecto commodi nostrum. Inventore voluptatum aut<br /> voluptatum non, amet 
                    </div>
                    <div className='uppercase text-lg font-semibold'>
                        <div className='flex gap-3'>
                            <img src={location} alt="location" className='w-10 bg-white rounded-lg' />
                            <p>15 olace bellcoeur 6500 paris</p>
                        </div>
