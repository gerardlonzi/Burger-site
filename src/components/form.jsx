        ...
        <div>
            <Container >
                ...
                <div className='relative mt-24 flex justify-center '>
                    ...
                    <form action="" method='' className='grid grid-cols-2 gap-7' onSubmit={(e)=>e.preventDefault()}>
                        <div className=''>
                        ...
                        <div className=''>
                            <input type="submit" value={'trouver une table'}   className='pointer mt-10 font text-2xl outline-none w-full pt-4 focus:border-yellow-600 focus:ring-amber-600 pb-3 rounded-md bg-red-700 text-center text-white  hover:bg-red-600 transition-all   ' />
                        </div>
                    </form>
